...
* registry.redhat.io/codeready-workspaces/dashboard-rhel8
* registry.redhat.io/codeready-workspaces/devfileregistry-rhel8
* registry.redhat.io/codeready-workspaces/devworkspace-controller-rhel8
* registry.redhat.io/codeready-workspaces/devworkspace-rhel8
...
* link:assembly/branding/branding-crw.css[assembly/branding/branding-crw.css] - replacement for link:https://github.com/eclipse-che/che-dashboard/tree/main/assets/branding/branding.css[Che default css], copied via link:https://github.com/redhat-developer/codeready-workspaces-images/blob/crw-2-rhel-8/crw-jenkins/jobs/CRW_CI/crw-server_2.x.jenkinsfile[Jenkinsfile] during Pipeline build
...
NOTE: In a future release (CRW 2.9), the link:https://github.com/eclipse-che/che-dashboard/[Che Dashboard] will become a separate image & deployment from the Che Server, which means the above information may become incorrect.
