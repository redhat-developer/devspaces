...
exports.FeaturedWriter = void 0;
const fs = require("fs-extra");
const path = require("path");
const inversify_1 = require("inversify");
let FeaturedWriter = class FeaturedWriter {
    writeReport(featuredJson) {
        return __awaiter(this, void 0, void 0, function* () {
            const featuredFolder = path.resolve(this.outputRootDirectory, 'v3', 'che-theia');
            yield fs.ensureDir(featuredFolder);
            const featuredJsonPath = path.resolve(featuredFolder, 'featured.json');
            yield fs.writeFile(featuredJsonPath, `${JSON.stringify(featuredJson, undefined, 2)}\n`);
        });
    }
};
__decorate([
