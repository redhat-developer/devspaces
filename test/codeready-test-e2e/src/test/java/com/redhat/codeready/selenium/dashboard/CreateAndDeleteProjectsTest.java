...
public class CreateAndDeleteProjectsTest {
  ...
  private static final String SECOND_PROJECT_NAME = PROJECT_NAME + "-1";
  ...
  public void createProjectTest() {
    ...
    projectSourcePage.waitCreatedProjectButton(PROJECT_NAME);

    // create 'vertx-health-checks-example-redhat' project
    projectSourcePage.clickOnAddOrImportProjectButton();
    projectSourcePage.selectSample(PROJECT_NAME);
    projectSourcePage.clickOnAddProjectButton();
    projectSourcePage.waitCreatedProjectButton(SECOND_PROJECT_NAME);
    ...
    theiaProjectTree.waitItem(SECOND_PROJECT_NAME);
  }
