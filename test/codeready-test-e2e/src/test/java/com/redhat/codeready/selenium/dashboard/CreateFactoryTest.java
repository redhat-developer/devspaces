...
public class CreateFactoryTest {
  ...
  private TestWorkspace createWorkspaceWithProject(String workspaceName) {
    // create a workspace from the Java stack with the kitchensink-example project
    ...
    projectSourcePage.selectSample("kitchensink-example");
    projectSourcePage.clickOnAddProjectButton();
    projectSourcePage.waitCreatedProjectButton("kitchensink-example");
