...
public class WorkspaceDetailsProjectsTest {
  ...
  private static final String NEW_PROJECT_NAME = PROJECT_NAME + "-1";
  ...
  public void checkSearchField() {
    final String textForSearching = "redhat-1";
  ...
  private void addSpringSampleToWorkspace() {
    ...
    projectSourcePage.typeGitRepositoryLocation(
        "https://github.com/openshift-vertx-examples/vertx-health-checks-example-redhat.git");
