...
public class LoginNewUserWithHtpasswdTest {
  ...
  @Test
  public void checkExistedCodereadyUserOcpProjectCreationAndRemoval() throws Exception {
    ...
    codereadyOpenShiftLoginPage.login(testUser.getName(), testUser.getPassword());
